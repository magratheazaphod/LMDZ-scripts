...
## PARALLELIZATION ## do we wish to use MPI alone, or a combination of MPI and OpenMP?
export useopenmp=0

## need to specify environmental variable that dicates number of threads

## MACHINE SPECIFIC - depends strongly on core architecture. 
